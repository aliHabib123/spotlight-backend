...
<head>
  ...
  <style>
    ...
    .status { display:flex; align-items:center; gap:12px; font-size: 20px; font-weight: 700; color: #dc2626; }
...
<body>
  <div class="container">
    <div class="status">
      <svg class="icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 8v5" stroke="#dc2626" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><circle cx="12" cy="16" r="1" fill="#dc2626"/><circle cx="12" cy="12" r="9" stroke="#dc2626" stroke-width="2"/></svg>
    ...
    <div class="actions">
      ...
      <a class="btn secondary" href="javascript:history.back()">Try Again</a>
    </div>
  </div>
</body>
</html>
